...
PSRC			= main.c project_ra.c \
			  build_ckt.c $(LEX_CPROG) $(YACC_CPROG)
POBJ			= main.o project_ra.o \
			  build_ckt.o lex.yy.o y.tab.o 
PHDR			= project_ra.h y.tab.h read_ckt.h
...
main.o: main.c project_ra.h
build_ckt.o: build_ckt.c  project_ra.h
project.o: project_ra.c project_ra.h
